...
<div id="sidebar"
    <?php if ($this->router->fetch_method() == 'water_user_associations' or $this->router->fetch_method() == 'payment_notesheets'  or $this->router->fetch_class() == 'water_user_associations' or $this->router->fetch_class() == 'expenses' or $this->router->fetch_class() == 'annual_work_plans' or $this->router->fetch_class() == 'riders') { ?>
