						...
						<tbody>
							<?php foreach ($financial_years as $financial_year) : ?>
								<tr>
									...
									<td>
										<a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR . "financial_years/view_financial_year/" . $financial_year->financial_year_id . "/" . $this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
										<a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR . "financial_years/restore/" . $financial_year->financial_year_id . "/" . $this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
										<a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR . "financial_years/delete/" . $financial_year->financial_year_id . "/" . $this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
									</td>
								</tr>
							<?php endforeach; ?>
						</tbody>
