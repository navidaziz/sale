		...
		<div class="box border blue" id="messenger">
			...
			<div class="box-body">
				...
				<div class="table-responsive">
					...
					<form method="post" action="<?php echo  site_url("suppliers/return_item_stocks") ?>">
					...
					<a href="<?php echo site_url("suppliers/print_supplier_return_item_lists/" . $supplier_id . "/" . $supplier_invoice_id); ?>" target="_new" class="btn btn-success pull-right" style="margin: 5px;">
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><a href="<?php echo site_url("suppliers/remove_supplier_item/" . $inventory->supplier_id . "/" . $inventory->supplier_invoice_id . "/" . $inventory->inventory_id . "/return") ?>">Remove</a></td>
								</tr>
