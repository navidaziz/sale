                    ...
                    <table class="table table-table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo $this->lang->line('sub_component_detail'); ?></th>
                        ...
                        <tbody>
                            <?php foreach ($sub_components as $sub_component) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $sub_component->project_name; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR . "sub_components/view_sub_component/" . $sub_component->sub_component_id . "/" . $this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
                                        <a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR . "sub_components/restore/" . $sub_component->sub_component_id . "/" . $this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
                                        <a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR . "sub_components/delete/" . $sub_component->sub_component_id . "/" . $this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
