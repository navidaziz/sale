...
function open_model(order_id) {
  ...
  $.ajax({
    ...
    if (data.order_status == 2) {
      var rider_list =
        '<table class="table table-stats"><tr><th></th><th>Rider Name</th><th>Orders</th><th>Assigned</th><th>Picking Add:</th><th>Drop Add:</th><th>Delivered</th></tr>';
      ...
      $.ajax({
        ...
        for (var i in data) {
          ...
          rider_list =
            rider_list +
            '<tr><td><input type="radio" name="rider_id" value="' +
            counter.rider_id +
            '" /></td><td>' +
            counter.rider_name +
            " <br />(" +
          ...
          if (counter.last_assigned_time) {
            ...
            rider_list = rider_list + "<td>-</td>";
          }

          rider_list =
            rider_list + "<td>" + counter.order_picking_address + "</td>";
          rider_list =
            rider_list + "<td>" + counter.order_drop_address + "</td>";
