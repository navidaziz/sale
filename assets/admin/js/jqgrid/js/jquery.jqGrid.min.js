  ...
  b.extend(b.jgrid, {
    ...
    parseDate: function (d, g, c, e) {
      var a = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/,
        i = "string" === typeof g ? g.match(a) : null,
        a = function (a, b) {
          a = "" + a;
      ...
      if (g && null != g)
        if (!isNaN(g - 0) && "u" === ("" + d).toLowerCase())
          ...
          (h = new Date(parseInt(i[1], 10))),
            i[3] &&
              ((d = 60 * Number(i[5]) + Number(i[6])),
              (d *= "-" === i[4] ? 1 : -1),
          ...
          for (k = d.length; j < k; j++)
            "M" === d[j] &&
              ((i = b.inArray(g[j], e.monthNames)),
              -1 !== i && 12 > i && ((g[j] = i + 1), (f.m = g[j]))),
              "F" === d[j] &&
                ((i = b.inArray(g[j], e.monthNames, 12)),
                -1 !== i && 11 < i && ((g[j] = i + 1 - 12), (f.m = g[j]))),
              "a" === d[j] &&
                ((i = b.inArray(g[j], e.AmPm)),
                -1 !== i &&
                  2 > i &&
                  g[j] === e.AmPm[i] &&
                  ((g[j] = i), (f.h = h(g[j], f.h)))),
              "A" === d[j] &&
                ...
                -1 !== i &&
                  1 < i &&
                  g[j] === e.AmPm[i] &&
                  ((g[j] = i - 2), (f.h = h(g[j], f.h)))),
              "g" === d[j] && (f.h = parseInt(g[j], 10)),
              void 0 !== g[j] && (f[d[j].toLowerCase()] = parseInt(g[j], 10));
          f.f && (f.m = f.f);
      ...
      var m = h.getMilliseconds(),
        ...
        E = {
          ...
          W:
            5 > r
              ? Math.floor((u + r - 1) / 7) + 1
              : Math.floor((u + r - 1) / 7) ||
                (4 > (new Date(l - 1, 0, 1).getDay() + 6) % 7 ? 53 : 52),
          ...
          O:
            (0 < j ? "-" : "+") +
            a(100 * Math.floor(Math.abs(j) / 60) + (Math.abs(j) % 60), 4),
          P: "?",
          T: (
            ("" + h).match(
      ...
      return c.replace(
        ...
        function (a) {
          return E.hasOwnProperty(a) ? E[a] : a.substring(1);
        }
      );
    },
    jqID: function (b) {
    ...
    from: function (d) {
      return new (function (d, c) {
        ...
        this._doSort = function (a, b) {
          ...
          b++;
          for (
            var d = e._getGroup(a, d, i, f, c), i = [], g, f = 0;
            f < d.length;
            f++
          ) {
        ...
        this._getGroup = function (a, d, c, i, f) {
          ...
          b.each(e._getOrder(a, d, c, i, f), function (a, c) {
            ...
            null == k && (k = "");
            e._equals(j, k) ||
              ((j = k), null !== h && g.push(h), (h = e._group(d, k)));
            h.items.push(c);
          });
          null !== h && g.push(h);
          return g;
          ...
          E
            ? e._append(
                e._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") +
                  ...
                  c +
                  ") == " +
                  e._getStr('"' + e._toStr(d) + '"')
              )
            : ((c = f ? b.trim(d.toString()).length : d.toString().length),
              e._append(
                e._getStr("this") +
                  ".substr(0," +
                  c +
        ...
        this.contains = function (a, b) {
          E
            ...
            : e._append(
                e._getStr("this") + '.indexOf("' + e._toStr(a) + '",0) > -1'
              );
        ...
        var e = b.extend(
          ...
          c = {
            ...
            dragStart: function (c, d, f) {
              ...
              this.curGbox = b(
                "#rs_m" + b.jgrid.jqID(e.id),
                "#gbox_" + b.jgrid.jqID(e.id)
              );
              this.curGbox.css({
                display: "block",
                left: d.clientX - 6,
            ...
            dragMove: function (a) {
              if (this.resizing) {
                ...
                33 < c &&
                  ...
                  !0 === e.forceFit
                    ? ((d = this.headers[this.resizing.idx + e.nv]),
                      (b = "ltr" === e.direction ? d.width - b : d.width + b),
                      33 < b && ((a.newWidth = c), (d.newWidth = b)))
                    : ((this.newWidth =
                        "ltr" === e.direction
                          ? e.tblwidth + b
                          : e.tblwidth - b),
            ...
            dragEnd: function () {
              ...
              if (this.resizing) {
                ...
                !0 === e.forceFit
                  ? ((d =
                      this.headers[c + e.nv].newWidth ||
                      this.headers[c + e.nv].width),
                    (this.headers[c + e.nv].width = d),
                    (this.headers[c + e.nv].el.style.width = d + "px"),
                    (this.cols[c + e.nv].style.width = d + "px"),
                    0 < this.footers.length &&
                      (this.footers[c + e.nv].style.width = d + "px"),
                    (e.colModel[c + e.nv].width = d))
                  : ((e.tblwidth = this.newWidth || e.tblwidth),
            ...
            populateVisible: function () {
              ...
              if (a) {
                ...
                if (d[0].rows.length)
                  try {
                    g = (f = d[0].rows[1])
                      ? b(f).outerHeight() || c.prevRowHeight
                      : c.prevRowHeight;
                  } catch (va) {
                    g = c.prevRowHeight;
                  }
                if (g) {
                  ...
                  if (
                    ...
                    (F = parseInt((a - k + g - 1) / g, 10)),
                      0 <= k || 2 > F || !0 === e.scroll
                        ? ((B = Math.round((k + f) / g) + 1), (j = -1))
                        : (j = 1);
                  0 < j &&
                    ((B = parseInt(f / g, 10) + 1),
                    (F = parseInt((f + a) / g, 10) + 2 - B),
                    (A = !0));
                  if (
                    F &&
                    (!e.lastpage ||
          ...
          if (this.p.colNames.length !== this.p.colModel.length)
            ...
            var n = function (a, b) {
              ...
              P = function () {
                ...
                d =
                  a.p.keyIndex === false || a.p.loadonce === true
                    ? a.p.localReader.id
              ...
              H = function (c, d, e, f, g) {
                var h = new Date(),
                  i =
                    (a.p.datatype !== "local" && a.p.loadonce) ||
                    a.p.datatype === "xmlstring",
                  j = a.p.xmlReader,
                ...
                if (b.isXMLDoc(c)) {
                  ...
                  var F = b(a),
                    ...
                    m = 0,
                    l,
                    q = a.p.multiselect === true ? 1 : 0,
                    v = 0,
                    u,
                    O = a.p.rownumbers === true ? 1 : 0,
                    r,
                    o = [],
                    $,
                    s = {},
                  ...
                  b.isFunction(j.userdata)
                    ? (a.p.userData = j.userdata.call(a, c) || {})
                    : b.jgrid.getXmlData(c, j.userdata, true).each(function () {
                  ...
                  if (c && z) {
                    ...
                    for (; J < z; ) {
                      ...
                      var M = p.length;
                      p.push("");
                      O && p.push(L(0, J, a.p.page, a.p.rowNum));
                  ...
                  if (a.p.gridview === true) {
                    ...
                    if (a.p.grouping) {
                      ...
                      a.p.treeGrid === true && t > 0
                        ? b(a.rows[t]).after(p.join(""))
                        : b("tbody:first", d).append(p.join(""));
                  }
                  if (a.p.subGrid === true)
                    try {
                  ...
                  a.p.userDataOnFooter &&
                    F.jqGrid("footerData", "set", a.p.userData, true);
                  if (i) {
                    a.p.records = z;
              ...
              U = function (c, d, e, f, g) {
                ...
                if (c) {
                  ...
                  a.p.lastpage = n(b.jgrid.getAccessor(c, d.total), 1);
                  ...
                  for (; t < c; ) {
                    ...
                    if (p === void 0) {
                      typeof s === "number" &&
                        a.p.colModel[s + q + v + o] != null &&
                        (p = b.jgrid.getAccessor(
                          g,
                          a.p.colModel[s + q + v + o].name
                        ));
                      if (p === void 0) {
                        p = H + t;
                  ...
                  if (a.p.gridview === true) {
                    ...
                    a.p.grouping
                      ...
                      : a.p.treeGrid === true && C > 0
                      ? b(a.rows[C]).after(I.join(""))
                      : b("#" + b.jgrid.jqID(a.p.id) + " tbody:first").append(
                          I.join("")
                        );
                  }
                  ...
                  a.p.treeANode = -1;
                  a.p.userDataOnFooter &&
                    k.jqGrid("footerData", "set", a.p.userData, true);
                  if (j) {
                    a.p.records = c;
                  ...
                  if (j)
                    for (; m < c && x[m]; ) {
                      ...
                      if (g) {
                        ...
                        for (l = 0; l < w.length; l++)
                          y[a.p.colModel[l + q + v + o].name] =
                            b.jgrid.getAccessor(g, w[l]);
                        y._id_ = b.jgrid.stripPref(a.p.idPrefix, p);
                        a.p.data.push(y);
                        a.p._index[y._id_] = a.p.data.length - 1;
                        y = {};
              ...
              ka = function () {
                function c(a) {
                  ...
                  if (a.groups != null) {
                    (e =
                      a.groups.length &&
                      a.groupOp.toString().toUpperCase() === "OR") &&
                      q.orBegin();
                  ...
                  if (a.rules != null)
                    try {
                      ...
                      for (d = 0; d < a.rules.length; d++) {
                        ...
                        if (o[i.op] && i.field) {
                          b > 0 && h && h === "OR" && (q = q.or());
                          q = o[i.op](q, h)(i.field, i.data, f[i.field]);
                        }
                        b++;
                      }
                      g && q.orEnd();
                            ...
                            b.extend(
                              {
                                ...
                                success: function (e, f, h) {
                                  if (
                                    ...
                                    a.p.beforeProcessing.call(a, e, f, h) ===
                                      false
                                  )
                                    Q();
                                  else {
                                    g === "xml"
                                      ? H(e, a.grid.bDiv, o, c > 1, j)
              ...
              la = function (c, d) {
                ...
                a.p.viewrecords === true &&
                  b("td#" + c + "_" + a.p.recordpos, "#" + j).append(
                    "<div dir='" +
                      g +
                      "' style='text-align:" +
                      a.p.recordpos +
                ...
                a.p.pginput === true &&
                  b("input.ui-pg-input", "#" + j).keypress(function (c) {
              ...
              ma = function (c, d, e, f, g) {
                if (a.p.colModel[d].sortable && !(a.p.savedRow.length > 0)) {
                  ...
                  if (a.p.multiSort) sa(d, g);
                    ...
                    b("span.ui-icon-" + a.p.sortorder, g).removeClass(
                      "ui-state-disabled"
                    );
            ...
            a.p.keyName = !1;
            for (f = 0; f < a.p.colModel.length; f++)
              (a.p.colModel[f] = b.extend(
                !0,
                {},
                a.p.cmTemplate,
                a.p.colModel[f].template || {},
                a.p.colModel[f]
              )),
                !1 === a.p.keyIndex &&
                  !0 === a.p.colModel[f].key &&
                  (a.p.keyIndex = f);
            ...
            if (a.p.multiSort) {
              ...
              for (f = 0; f < da.length; f++)
                (D = b.trim(da[f]).split(" ")),
                  (da[f] = b.trim(D[0])),
                  (qa[f] = D[1] ? b.trim(D[1]) : a.p.sortorder || "asc");
            }
            for (f = 0; f < this.p.colNames.length; f++)
              (D = a.p.headertitles
                ? ' title="' + b.jgrid.stripHtml(a.p.colNames[f]) + '"'
                : ""),
                (x +=
                  "<th id='" +
                  a.p.id +
                  ...
                  D +
                  ">"),
                (D = a.p.colModel[f].index || a.p.colModel[f].name),
                (x +=
                  "<div id='jqgh_" +
                  a.p.id +
                  "_" +
                ...
                (a.p.colModel[f].width = a.p.colModel[f].width
                  ? parseInt(a.p.colModel[f].width, 10)
                  : 150),
                "boolean" !== typeof a.p.colModel[f].title &&
                  (a.p.colModel[f].title = !0),
                (a.p.colModel[f].lso = ""),
                D === a.p.sortname && (a.p.lastsort = f),
                a.p.multiSort &&
                  ((D = b.inArray(D, da)),
                  -1 !== D && (a.p.colModel[f].lso = qa[D])),
                (x += X + "</div></th>");
            X = null;
            ...
            if (this.p.multiselect) {
              ...
              b("#cb_" + b.jgrid.jqID(a.p.id), this).bind("click", function () {
                ...
                b.isFunction(a.p.onSelectAll) &&
                  a.p.onSelectAll.call(a, Y ? a.p.selarrrow : ha, Y);
              });
            }
            !0 === a.p.autowidth &&
            ...
            (function () {
              ...
              if (isNaN(a.p.width))
                a.p.width =
                  d + (a.p.shrinkToFit === false && !isNaN(a.p.height) ? h : 0);
              c.width = a.p.width;
              a.p.tblwidth = d;
              ...
              if (a.p.shrinkToFit === true && f > 0) {
                ...
                b.each(a.p.colModel, function (b) {
                  if (this.hidden === false && !this.fixed) {
                    this.width = j = Math.round(
                      (m * this.width) / (a.p.tblwidth - e * f - l)
                    );
                    d = d + j;
                    g = b;
                  }
            ...
            b("th", j)
              ...
              .mousedown(function (d) {
                if (
                  b(d.target).closest("th>span.ui-jqgrid-resize").length === 1
                ) {
                  var e = na(this);
            ...
            !1 === a.p.cellEdit &&
              ...
              b(a)
                .bind("mouseover", function (a) {
                  ...
                  b(o).attr("class") !== "ui-subgrid" &&
                    b(o).addClass("ui-state-hover");
                })
            ...
            b(a)
              ...
              .click(function (c) {
                ...
                if (
                  b(o).length === 0 ||
                  o[0].className.indexOf("ui-state-disabled") > -1 ||
                  (
                    b(w, a).closest("table.ui-jqgrid-btable").attr("id") || ""
                ...
                (e = e === false || e === "stop" ? false : true) &&
                  ...
                  (e = a.p.beforeSelectRow.call(a, o[0].id, c));
                if (
                  !(
                    w.tagName === "A" ||
                    ((w.tagName === "INPUT" ||
                  ...
                  b.isFunction(a.p.onCellSelect) &&
                    a.p.onCellSelect.call(a, z, K, ia, c);
                  if (a.p.cellEdit === true)
                    ...
                    if (c[a.p.multikey])
                      ...
                      if (a.p.multiselect && d) {
                        d = b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + z).is(
                          ":checked"
                        );
                        b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + z)[
                          a.p.useProp ? "prop" : "attr"
                        ]("checked", d);
                      }
                    }
              ...
              .dblclick(function (c) {
                ...
                if (b(o).length !== 0) {
                  ...
                  b.isFunction(a.p.ondblClickRow) &&
                    a.p.ondblClickRow.call(a, b(o).attr("id"), z, K, c);
                }
              })
              .bind("contextmenu", function (c) {
                ...
                if (b(o).length !== 0) {
                  a.p.multiselect ||
                    b(a).jqGrid("setSelection", o[0].id, true, c);
                  z = o[0].rowIndex;
                  K = b.jgrid.getCellIndex(w);
                  ...
                  b.isFunction(a.p.onRightClickRow) &&
                    a.p.onRightClickRow.call(a, b(o).attr("id"), z, K, c);
                }
              });
            c.bDiv = document.createElement("div");
            k &&
              "auto" === ("" + a.p.height).toLowerCase() &&
              (a.p.height = "100%");
            b(c.bDiv)
              .append(
                b(
                  '<div style="position:relative;' +
                    (k && 8 > b.jgrid.msiever() ? "height:0.01%;" : "") +
                    '"></div>'
                )
                  .append("<div></div>")
                  .append(this)
            ...
            a.p.footerrow &&
              ...
              b(c.sDiv).append(f).width(c.width).insertAfter(c.hDiv),
              b(f).append(N),
              ...
              !0 === a.p.hidegrid &&
                (b(".ui-jqgrid-titlebar-close", c.cDiv).click(function (d) {
                  ...
                  a.p.gridstate === "visible"
                    ...
                    : a.p.gridstate === "hidden" &&
                      b(f, "#gbox_" + b.jgrid.jqID(a.p.id)).slideDown(
                        "fast",
                        function () {
                          g--;
                          if (g === 0) {
            ...
            a.updatepager = function (c, d) {
              ...
              if (
                (m =
                  m +
                  (a.p.toppager ? (m ? "," + a.p.toppager : a.p.toppager) : ""))
              ) {
                ...
                if (a.p.viewrecords)
                  if (a.p.reccount === 0)
                    ...
                    b(".ui-paging-info", m).html(
                      b.jgrid.format(a.p.recordtext, h, i, j)
                    );
                  }
                if (a.p.pgbuttons === true) {
                  e <= 0 && (e = f = 0);
  ...
  b.jgrid.extend({
    ...
    getDataIDs: function () {
      ...
      this.each(function () {
        if ((c = this.rows.length) && 0 < c)
          for (; g < c; )
            b(this.rows[g]).hasClass("jqgrow") &&
              ((d[e] = this.rows[g].id), e++),
              g++;
      });
      return d;
    },
    setSelection: function (d, g, c) {
      return this.each(function () {
        ...
        if (
          void 0 !== d &&
          ((g = !1 === g ? !1 : !0),
          (a = b(this).jqGrid("getGridRowById", d)) &&
            a.className &&
            !(-1 < a.className.indexOf("ui-state-disabled")))
        )
          if (
            (!0 === this.p.scrollrows &&
              ((i = b(this).jqGrid("getGridRowById", d).rowIndex),
              0 <= i &&
                ((e = b(this.grid.bDiv)[0].clientHeight),
                (f = b(this.grid.bDiv)[0].scrollTop),
                (h = b(this.rows[i]).position().top),
                (i = this.rows[i].clientHeight),
                h + i >= e + f
                  ? (b(this.grid.bDiv)[0].scrollTop = h - (e + f) + i + f)
                  : h < e + f &&
                    h < f &&
            ...
            if (
              ...
              (this.p.selrow = a.id),
              (f = b.inArray(this.p.selrow, this.p.selarrrow)),
              -1 === f
              ...
              j &&
                (-1 === f
                  ? b("#" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(j)).addClass(
                      "ui-state-highlight"
                    )
                  : b("#" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(j)).removeClass(
                      "ui-state-highlight"
                    ),
                b(
                  "#jqg_" + b.jgrid.jqID(this.p.id) + "_" + b.jgrid.jqID(d),
                  "#" + b.jgrid.jqID(j)
    ...
    resetSelection: function (d) {
      return this.each(function () {
        ...
        if (void 0 !== d) {
          ...
          b("#" + b.jgrid.jqID(g.p.id) + " tbody:first tr#" + b.jgrid.jqID(c))
            .removeClass("ui-state-highlight")
            .attr("aria-selected", "false");
          e &&
            b("#" + b.jgrid.jqID(c), "#" + b.jgrid.jqID(e)).removeClass(
              "ui-state-highlight"
            );
          if (g.p.multiselect) {
            b(
              "#jqg_" + b.jgrid.jqID(g.p.id) + "_" + b.jgrid.jqID(c),
              "#" + b.jgrid.jqID(g.p.id)
            )[g.p.useProp ? "prop" : "attr"]("checked", !1);
            if (e)
              b(
                "#jqg_" + b.jgrid.jqID(g.p.id) + "_" + b.jgrid.jqID(c),
                "#" + b.jgrid.jqID(e)
          ...
          g.p.multiselect
            ? (b(g.p.selarrrow).each(function (a, c) {
                b(b(g).jqGrid("getGridRowById", c))
                  .removeClass("ui-state-highlight")
                  .attr("aria-selected", "false");
                b("#jqg_" + b.jgrid.jqID(g.p.id) + "_" + b.jgrid.jqID(c))[
            ...
            : g.p.selrow &&
              ...
              (g.p.selrow = null));
        !0 === g.p.cellEdit &&
          0 <= parseInt(g.p.iCol, 10) &&
          0 <= parseInt(g.p.iRow, 10) &&
          (b("td:eq(" + g.p.iCol + ")", g.rows[g.p.iRow]).removeClass(
            "edit-cell ui-state-highlight"
          ),
          b(g.rows[g.p.iRow]).removeClass("selected-row ui-state-hover"));
        g.p.savedRow = [];
      });
    },
    getRowData: function (d) {
      ...
      this.each(function () {
        ...
        for (; i < a; )
          e && (j = f.rows[i]),
            b(j).hasClass("jqgrow") &&
              (b('td[role="gridcell"]', j).each(function (a) {
                  ...
                  if (!0 === f.p.treeGrid && h === f.p.ExpandColumn)
                    ...
                    try {
                      g[h] = b.unformat.call(
                        f,
                        this,
                        { rowId: j.id, colModel: f.p.colModel[a] },
                        a
                      );
                    } catch (c) {
    ...
    delRowData: function (d) {
      ...
      this.each(function () {
        ...
        g = !0;
        this.p.multiselect &&
          ((e = b.inArray(d, this.p.selarrrow)),
    ...
    setRowData: function (d, g, c) {
      ...
      this.each(function () {
            ...
            if (
              (b(this.p.colModel).each(function (a) {
                ...
                void 0 !== c &&
                  ((m[e] =
                    ...
                    "date" === this.formatter
                      ? b.unformat.date.call(f, c, this)
                      : c),
                  (h = f.formatter(d, c, a, g, "edit")),
                  (i = this.title ? { title: b.jgrid.stripHtml(h) } : {}),
                  !0 === f.p.treeGrid && e === f.p.ExpandColumn
                    ? b("td[role='gridcell']:eq(" + a + ") > span:first", j)
                        .html(h)
                        .attr(i)
                    : b("td[role='gridcell']:eq(" + a + ")", j)
                        .html(h)
                        .attr(i));
              }),
              "local" === f.p.datatype)
              ...
              if (f.p.treeGrid)
                for (r in f.p.treeReader)
                  f.p.treeReader.hasOwnProperty(r) &&
                    delete m[f.p.treeReader[r]];
        ...
        a &&
          ("string" === k ? b(j).addClass(c) : "object" === k && b(j).css(c),
          b(f).triggerHandler("jqGridAfterGridComplete"));
      });
      return a;
    },
        ...
        this.each(function () {
          ...
          for (
            var P = 0,
              Z = "",
              H = {},
              U = b.isFunction(this.p.afterInsertRow) ? true : false;
            P < W;
            ...
            j && (f[f.length] = b(this).jqGrid("addSubGridCell", h + k, 1));
                ...
                case "after":
                  if ((m = b(this).jqGrid("getGridRowById", e))) {
                    b(this.rows[m.rowIndex + 1]).hasClass("ui-subgrid")
                      ? b(this.rows[m.rowIndex + 1]).after(f)
                      : b(m).after(f.join(""));
                    m = m.rowIndex + 1;
                  }
                  break;
            ...
            U && this.p.afterInsertRow.call(this, d, L, L);
            P++;
          ...
          this.p.altRows === true &&
            ...
            (c === "last"
              ? (this.rows.length - 1) % 2 === 1 &&
                b(this.rows[this.rows.length - 1]).addClass(T)
              : b(this.rows).each(function (a) {
    ...
    footerData: function (d, g, c) {
      ...
      this.each(function () {
        ...
        b(this.p.colModel).each(function (e) {
          ...
          "set" === d
            ? void 0 !== g[a] &&
              ((k = c ? j.formatter("", g[a], e, g, "edit") : g[a]),
              (h = this.title ? { title: b.jgrid.stripHtml(k) } : {}),
              b("tr.footrow td:eq(" + e + ")", j.grid.sDiv)
                .html(k)
                .attr(h),
              (i = !0))
            : "get" === d &&
              (f[a] = b("tr.footrow td:eq(" + e + ")", j.grid.sDiv).html());
        });
      });
      return "get" === d ? f : i;
    },
        ...
        if (c.grid) {
          ...
          b(this.p.colModel).each(function (h) {
            if (-1 !== b.inArray(this.name, d) && this.hidden === f) {
              ...
              c.p.footerrow &&
                b("tr.footrow td:eq(" + h + ")", c.grid.sDiv).css("display", g);
              i = parseInt(this.width, 10);
              c.p.tblwidth =
                "none" === g ? c.p.tblwidth - (i + a) : c.p.tblwidth + (i + a);
              this.hidden = !f;
              e = !0;
    ...
    remapColumns: function (d, g, c) {
      ...
      g &&
        a(
          b("#" + b.jgrid.jqID(i.p.id) + " tbody:first"),
      ...
      i.p.remapColumns &&
        (i.p.remapColumns.length
          ? e(i.p.remapColumns)
          : (i.p.remapColumns = b.makeArray(d)));
      ...
      return this.each(function () {
        if (this.grid) {
          ...
          if (!isNaN(d)) {
            ...
            !0 === c.p.toolbar[0] &&
              (b(c.grid.uDiv).css("width", d + "px"),
              "both" === c.p.toolbar[1] &&
                b(c.grid.ubDiv).css("width", d + "px"));
            ...
            if (!0 === g) {
              ...
              l = 0;
              j
                ? d - n - (a + i * h) !== k && (l = d - n - (a + i * h) - k)
                : 1 !== Math.abs(d - n - (a + i * h)) &&
                  (l = d - n - (a + i * h));
              c.p.colModel[f].width += l;
              c.p.tblwidth = a + l + i * h + n;
              c.p.tblwidth > d
                ? ((j = c.p.tblwidth - parseInt(d, 10)),
                  (c.p.tblwidth = d),
                  (e = c.p.colModel[f].width -= j))
                : (e = c.p.colModel[f].width);
      ...
      return this.each(function () {
        ...
        if (
          ...
          (isNaN(g)
            ...
            : (f = parseInt(g, 10)),
          0 <= f && (h = b(this).jqGrid("getGridRowById", d)))
        ) {
          var k = b("td:eq(" + f + ")", h);
          if ("" !== c || !0 === i)
            (h = this.formatter(d, c, f, h, "edit")),
              (j = this.p.colModel[f].title
                ? { title: b.jgrid.stripHtml(h) }
                : {}),
              this.p.treeGrid && 0 < b(".tree-wrap", b(k)).length
                ? b("span", b(k)).html(h).attr(j)
                : b(k).html(h).attr(j),
              "local" === this.p.datatype &&
                ...
                (c =
                  ...
                  "date" === h.formatter
                    ...
                    : c),
                (j = this.p._index[b.jgrid.stripPref(this.p.idPrefix, d)]),
                void 0 !== j && (this.p.data[j][h.name] = c));
          ...
          if (a)
            try {
              c = b.unformat.call(
                this,
                b("td:eq(" + e + ")", a),
                { rowId: a.id, colModel: this.p.colModel[e] },
                e
              );
            } catch (i) {
            ...
            for (; n < m; ) {
              if (b(this.rows[n]).hasClass("jqgrow")) {
                try {
                  a = b.unformat.call(
                    this,
                    b(this.rows[n].cells[k]),
                    { rowId: this.rows[n].id, colModel: this.p.colModel[k] },
                    k
                  );
                } catch (r) {
                ...
                c
                  ? ((j = parseFloat(a)),
                    isNaN(j) ||
                      ...
                      l++))
                  : g
                  ? e.push({ id: this.rows[n].id, value: a })
                  : e.push(a);
              }
              n++;
            }
    ...
    getInd: function (d, g) {
      var c = !1,
        e;
      this.each(function () {
        (e = b(this).jqGrid("getGridRowById", d)) &&
          (c = !0 === g ? e : e.rowIndex);
      });
      return c;
    },
          ...
          if (a)
            if (
              ...
              37 === d.keyCode &&
                ...
                b.isFunction(g.onLeftKey) && g.onLeftKey.call(c, c.p.selrow));
              39 === d.keyCode &&
                (c.p.treeGrid &&
                  !c.p.data[h][j] &&
                  b(a).find("div.treeclick").trigger("click"),
                b(c).triggerHandler("jqGridKeyRight", [c.p.selrow]),
                b.isFunction(g.onRightKey) && g.onRightKey.call(c, c.p.selrow));
            } else
              13 === d.keyCode
                ? (b(c).triggerHandler("jqGridKeyEnter", [c.p.selrow]),
                  b.isFunction(g.onEnter) && g.onEnter.call(c, c.p.selrow))
                : 32 === d.keyCode &&
                  (b(c).triggerHandler("jqGridKeySpace", [c.p.selrow]),
                  b.isFunction(g.onSpace) && g.onSpace.call(c, c.p.selrow));
        });
      });
    },
    unbindKeys: function () {
    ...
    getLocalRow: function (d) {
      ...
      this.each(function () {
        void 0 !== d &&
          ((c = this.p._index[b.jgrid.stripPref(this.p.idPrefix, d)]),
          0 <= c && (g = this.p.data[c]));
      });
      return g;
    }
  ...
  a.jgrid.extend({
      ...
      return this.each(function () {
        ...
        if (this.grid) {
          ...
          for (i = 0; i < this.p.colModel.length; i++)
            if (
              this.p.colModel[i].index === a ||
              this.p.colModel[i].name === a
            ) {
              d = i;
              !0 === this.p.frozenColumns &&
                !0 === this.p.colModel[i].frozen &&
                (h = this.grid.fhDiv.find("#" + this.p.id + "_" + a));
              break;
            }
          -1 !== d &&
            ((i = this.p.colModel[d].sortable),
            "boolean" !== typeof i && (i = !0),
            "boolean" !== typeof c && (c = !1),
            i && this.sortData("jqgh_" + this.p.id + "_" + a, d, c, e, h));
        }
      });
    },
    ...
    filterToolbar: function (b) {
      ...
      return this.each(function () {
        ...
        if (!this.ftoolbar) {
          var e = function () {
            ...
            d = function (k, g, f) {
              ...
              var g = parseInt(g, 10),
                ...
                j = a(k).attr("colname");
              for (
                i = c.p.colModel.length;
                d < i && c.p.colModel[d].name !== j;
              ...
              j.sopt ||
                ((j.sopt = []),
                (j.sopt[0] = "select" === d.stype ? "eq" : b.defaultSearch));
              a.each(b.odata, function () {
                h.push(this.oper);
              });
              for (d = 0; d < j.sopt.length; d++)
                (m = a.inArray(j.sopt[d], h)),
                  -1 !== m &&
                    ((i = f === b.odata[m].oper ? "ui-state-highlight" : ""),
                    (g +=
          ...
          a.each(c.p.colModel, function (k) {
            ...
            if (this.search) {
              if (b.searchOperators) {
                ...
                d =
                  "<a title='" +
                  (null != f.searchtitle ? f.searchtitle : b.operandTitle) +
              ...
              switch (this.stype) {
                case "select":
                  if ((d = this.surl || f.dataUrl))
                    ...
                    g.searchoptions
                      ? ((n =
                          void 0 === g.searchoptions.value
                            ? ""
                            : g.searchoptions.value),
                        (r =
                          void 0 === g.searchoptions.separator
                            ? ":"
                            : g.searchoptions.separator),
                        (q =
                          void 0 === g.searchoptions.delimiter
                            ? ";"
                            : g.searchoptions.delimiter))
                      : g.editoptions &&
                        ((n =
                          void 0 === g.editoptions.value
                            ? ""
                            : g.editoptions.value),
                        (r =
                          void 0 === g.editoptions.separator
                            ? ":"
                            : g.editoptions.separator),
                        (q =
                          void 0 === g.editoptions.delimiter
                            ? ";"
                            : g.editoptions.delimiter));
                    if (n) {
                ...
                case "custom":
                  ...
                  try {
                    if (a.isFunction(f.custom_element)) {
                      var v = f.custom_element.call(
                        c,
                        void 0 !== f.defaultValue ? f.defaultValue : "",
                        f
                      );
                      if (v)
                        (v = a(v).addClass("customelement")),
                          a(j).find(">span").append(v);
                      else throw "e2";
                    } else throw "e1";
                  } catch (u) {
                    "e1" === u &&
          ...
          b.searchOperators &&
            (a(".soptclass", i).click(function (b) {
              var c = a(this).offset();
              d(this, c.left, c.top);
              b.stopPropagation();
            }),
          ...
          a(".clearsearchclass", i).click(function () {
            ...
            c.p.colModel[g].stype === "select"
              ? f
                ? a("td.ui-search-input select", d).val(f)
                : (a("td.ui-search-input select", d)[0].selectedIndex = 0)
              : a("td.ui-search-input input", d).val(f);
            b.autosearch === true && e();
          });
          this.ftoolbar = !0;
          ...
          this.clearToolbar = function (d) {
            ...
            a.each(c.p.colModel, function () {
              var b,
                d = a(
                  "#gs_" + a.jgrid.jqID(this.name),
                  this.frozen === true && c.p.frozenColumns === true
                    ? c.grid.fhDiv
                    : c.grid.hDiv
                );
              if (
            ...
            var l =
              a(c).triggerHandler("jqGridToolbarBeforeClear") === "stop"
                ? true
                : false;
    ...
    setGroupHeaders: function (b) {
      ...
      return this.each(function () {
        ...
        void 0 === l[0]
          ? (l = a("<tr>", { role: "row", "aria-hidden": "true" })
...
(function (a) {
  a.extend(a.jgrid, {
    ...
    createModal: function (d, b, c, g, e, h, f) {
      ...
      var n = a("<a class='ui-jqdialog-titlebar-close ui-corner-all'></a>")
        .hover(
          function () {
      ...
      j &&
        ...
        ((g =
          a(c.gbox).width() -
          (!isNaN(c.width) ? parseInt(c.width, 10) : 0) -
          8),
      ...
      if (c.drag)
        if ((a(l).css("cursor", "move"), a.fn.jqDrag)) a(i).jqDrag(l);
          ...
          try {
            a(i).draggable({ handle: a("#" + a.jgrid.jqID(l.id)) });
          } catch (o) {}
      if (c.resize)
        if (a.fn.jqResize)
          a(i).append(
      ...
      switch (d) {
        ...
        case "select":
          ...
          if (void 0 !== b.dataUrl) {
                    ...
                    if (b) {
                      ...
                      setTimeout(function () {
                        a("option", c).each(function (b) {
                          ...
                          if (
                            a.inArray(a.trim(a(this).text()), d) > -1 ||
                            a.inArray(a.trim(a(this).val()), d) > -1
                          )
            ...
            var l,
              n,
              m = void 0 === b.separator ? ":" : b.separator,
            ...
            if ("string" === typeof b.value) {
              ...
              for (k = 0; k < l.length; k++) {
                ...
                if (
                  d &&
                  (-1 < a.inArray(a.trim(n[1]), g) ||
                    -1 < a.inArray(a.trim(n[0]), g))
                )
                  e.selected = "selected";
              }
              ...
              for (k in ((m = b.value), m))
                if (m.hasOwnProperty(k)) {
                  ...
                  if (
                    !d &&
                    (a.trim(k) === a.trim(c) || a.trim(m[k]) === a.trim(c))
                  )
                    e.selected = "selected";
                  if (
                    d &&
                    (-1 < a.inArray(a.trim(m[k]), g) ||
    ...
    checkDate: function (a, b) {
      ...
      return 1 > j.length ||
        ...
        (2 === c[a[f]] &&
          c[a[h]] >
            (0 === c[a[g]] % 4 && (0 !== c[a[g]] % 100 || 0 === c[a[g]] % 400)
              ? 29
              : 28)) ||
        c[a[h]] > i[c[a[f]]]
        ? !1
...
(function (a) {
  ...
  a.jgrid.extend({
      ...
      return this.each(function () {
        ...
        if (e.grid) {
          ...
          if (void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0])
            ...
            b.columns.length
              ? ((v = b.columns), (x = 0), (l = v[0].index || v[0].name))
            ...
            if ((!o && l) || !1 === b.multipleSearch) {
              var A = "eq";
              0 <= x && v[x].searchoptions && v[x].searchoptions.sopt
                ? (A = v[x].searchoptions.sopt[0])
                : b.sopt && b.sopt.length && (A = b.sopt[0]);
            ...
            (b.searchOnEnter || b.closeOnEscape) &&
              a("#" + a.jgrid.jqID(q.themodal)).keydown(function (c) {
                var d = a(c.target);
                if (
                  b.searchOnEnter &&
                  c.which === 13 &&
            ...
            a("#" + h + "_search").bind("click", function () {
              ...
              r &&
                ...
                (r = b.onSearch.call(e, e.p.filters));
      ...
      return this.each(function () {
            ...
            if (c.length) {
              ...
              a.each(d.p.colModel, function () {
                if (
                  ...
                  try {
                    if (
                      ((j[b] = this.editoptions.custom_value.call(
                        d,
                        a("#" + a.jgrid.jqID(b), l),
                        "get"
                      )),
              ...
              d.p.autoencode &&
                (j[this.name] = a.jgrid.htmlEncode(j[this.name]));
            }
          });
          return !0;
        }
            ...
            if (
              ...
              if (!1 === z) h = "";
                ...
                try {
                  h = a.unformat.call(
                    e,
                    a("td[role='gridcell']:eq(" + p + ")", e.rows[z]),
                  ...
                  h =
                    this.edittype && "textarea" === this.edittype
                      ? a("td[role='gridcell']:eq(" + p + ")", e.rows[z]).text()
                      : a(
                          "td[role='gridcell']:eq(" + p + ")",
                          e.rows[z]
                        ).html();
                }
                if (
                  ...
                  "&nbsp;" === h ||
                  "&#160;" === h ||
                  (1 === h.length && 160 === h.charCodeAt(0))
                )
                  h = "";
              }
              var r = a.extend({}, this.editoptions || {}, { id: i, name: i }),
                q = a.extend(
                  {},
                  {
                    elmprefix: "",
              ...
              "_empty" === c &&
                r.defaultValue &&
                (h = a.isFunction(r.defaultValue)
                  ? r.defaultValue.call(d)
                  : r.defaultValue);
              this.edittype || (this.edittype = "text");
              d.p.autoencode && (h = a.jgrid.htmlDecode(h));
              o = a.jgrid.createEl.call(
                d,
                this.edittype,
                r,
                h,
              ...
              -1 <
                a.inArray(this.edittype, [
                  ...
                  "password",
                  "select"
                ]) && a(o).addClass("ui-widget-content ui-corner-all");
              ...
              0 === l.length &&
                ((l = a("<tr " + m + " rowpos='" + x + "'></tr>")
                  .addClass("FormData")
                  .attr("id", "tr_" + i)),
                a(l).append(s),
                a(k).append(l),
                (l[0].rp = x));
              a("td:eq(" + (w - 2) + ")", l[0]).html(
                void 0 === q.label ? e.p.colNames[p] : q.label
              );
              a("td:eq(" + (w - 1) + ")", l[0])
                .append(q.elmprefix)
                .append(o)
              ...
              "custom" === this.edittype &&
                a.isFunction(r.custom_value) &&
                r.custom_value.call(d, a("#" + i, "#" + g), "set", h);
        ...
        function u(c, e, g) {
          ...
          if ("_empty" === c)
            a(m).each(function () {
              ...
              if (
                (j = a("#" + a.jgrid.jqID(k), "#" + g)) &&
                j.length &&
                null !== j[0]
              )
                if (
                  ((n = ""),
                  "custom" === this.edittype && a.isFunction(h.custom_value)
                    ? h.custom_value.call(d, a("#" + k, "#" + g), "set", n)
                    : h.defaultValue
                    ? ((n = a.isFunction(h.defaultValue)
                        ? h.defaultValue.call(d)
                        : h.defaultValue),
                      "checkbox" === j[0].type
                        ? ((o = n.toLowerCase()),
                          0 > o.search(/(false|f|0|no|n|off|undefined)/i) &&
                          "" !== o
                            ? ((j[0].checked = !0),
            ...
            p &&
              (a('td[role="gridcell"]', p).each(function (j) {
                k = m[j].name;
                if (
                  "cb" !== k &&
                  "subgrid" !== k &&
                  ...
                  switch (m[j].edittype) {
                      ...
                      a("#" + k + " option", "#" + g).each(function () {
                        this.selected =
                          ...
                          (a.trim(f) === a.trim(a(this).text()) ||
                            n[0] === a.trim(a(this).text()) ||
                            n[0] === a.trim(a(this).val()))
                            ? !0
                            : m[j].editoptions.multiple
                            ? -1 < a.inArray(a.trim(a(this).text()), n) ||
                              -1 < a.inArray(a.trim(a(this).val()), n)
                              ? !0
                              : !1
                            : !1;
                      });
                    ...
                    case "custom":
                      try {
                        if (
                          m[j].editoptions &&
                          a.isFunction(m[j].editoptions.custom_value)
                        )
                          m[j].editoptions.custom_value.call(
                            d,
                            a("#" + k, "#" + g),
                            "set",
                            f
        ...
        function q() {
          var e,
            ...
            z,
            s,
            q = a(d).triggerHandler("jqGridAddEditBeforeCheckValues", [
              a("#" + g),
              w
            ]);
          q && "object" === typeof q && (j = q);
          a.isFunction(b[d.p.id].beforeCheckValues) &&
            (q = b[d.p.id].beforeCheckValues.call(d, j, a("#" + g), w)) &&
            "object" === typeof q &&
            (j = q);
          for (o in j)
            if (
          ...
          k[0] &&
            ...
            void 0 === f &&
              ...
              (f = b[d.p.id].onclickSubmit.call(d, b[d.p.id], j, w) || {}),
            (k = a(d).triggerHandler("jqGridAddEditBeforeSubmit", [
              j,
              a("#" + g),
              w
            ])),
            ...
            k[0] &&
              ...
              (k = b[d.p.id].beforeSubmit.call(d, j, a("#" + g), w)));
          if (k[0] && !b[d.p.id].processing) {
            ...
            h = i.id;
            j[m] =
              "_empty" === a.trim(j[d.p.id + "_id"]) ? i.addoper : i.editoper;
            j[m] !== i.addoper
              ? (j[h] = j[d.p.id + "_id"])
              : void 0 === j[h] && (j[h] = j[d.p.id + "_id"]);
            delete j[d.p.id + "_id"];
            j = a.extend(j, b[d.p.id].editData, f);
            if (!0 === d.p.treeGrid)
              for (s in (j[m] === i.addoper &&
                ((z = a(d).jqGrid("getGridParam", "selrow")),
                (j[
              ...
              d.p.treeReader))
                d.p.treeReader.hasOwnProperty(s) &&
                  ((f = d.p.treeReader[s]),
                  j.hasOwnProperty(f) &&
                    !(j[m] === i.addoper && "parent_id_field" === s) &&
                    delete j[f]);
            ...
            s = a.extend(
              {
                ...
                complete: function (f, o) {
                  ...
                  if (f.status >= 300 && f.status !== 304) {
                    k[0] = false;
                    k[1] = a(d).triggerHandler("jqGridAddEditErrorTextFormat", [
                      f,
                      w
                    ]);
                    k[1] = a.isFunction(b[d.p.id].errorTextFormat)
                      ? b[d.p.id].errorTextFormat.call(d, f, w)
                      : o +
                        " Status: '" +
                        f.statusText +
                        "'. Error code: " +
                    ...
                    k = a(d).triggerHandler("jqGridAddEditAfterSubmit", [
                      f,
                      j,
                      w
                    ]);
                    ...
                    k[0] &&
                      ...
                      (k = b[d.p.id].afterSubmit.call(d, f, j, w));
                  }
                  if (k[0] === false) {
                    ...
                    if (j[m] === i.addoper) {
                      ...
                      b[d.p.id].reloadAfterSubmit
                        ...
                        : d.p.treeGrid === true
                        ? a(d).jqGrid("addChildNode", k[2], z, j)
                      ...
                      if (b[d.p.id].reloadAfterSubmit) {
                        ...
                        d.p.treeGrid === true
                          ? a(d).jqGrid("setTreeRow", j[h], j)
                          : a(d).jqGrid("setRowData", j[h], j);
                      b[d.p.id].closeAfterEdit &&
                        a.jgrid.hideModal("#" + a.jgrid.jqID(n.themodal), {
                          gb: "#gbox_" + a.jgrid.jqID(p),
                          jqm: c.jqModal,
            ...
            !s.url &&
              ...
              (a.isFunction(d.p.dataProxy)
                ...
                : ((k[0] = !1), (k[1] += " " + a.jgrid.errors.nourl)));
            k[0] &&
              (b[d.p.id].useDataProxy
                ? ((f = d.p.dataProxy.call(d, s, "set_" + d.p.id)),
                  ...
                  !1 === f[0]
                    ? ((k[0] = !1),
                      (k[1] = f[1] || "Error deleting the selected row!"))
                    : (s.data.oper === i.addoper &&
          ...
          !1 === k[0] &&
            (a("#FormError>td", l).html(k[1]), a("#FormError", l).show());
        }
        function o(a, c) {
          var b = !1,
            d;
        ...
        function f() {
          ...
          if (
            ...
            ((j = {}), e(), (K = o(j, b[d.p.id]._savedData)))
          )
            a("#" + g).data("disabled", !0),
              a(".confirm", "#" + n.themodal).show(),
              (c = !1);
          return c;
        }
        function i() {
        ...
        function t(c, b) {
          var d = b[1].length - 1;
          0 === c
            ? a("#pData", l + "_2").addClass("ui-state-disabled")
            : void 0 !== b[1][c - 1] &&
              a("#" + a.jgrid.jqID(b[1][c - 1])).hasClass("ui-state-disabled")
            ? a("#pData", l + "_2").addClass("ui-state-disabled")
            : a("#pData", l + "_2").removeClass("ui-state-disabled");
          c === d
            ? a("#nData", l + "_2").addClass("ui-state-disabled")
            : void 0 !== b[1][c + 1] &&
              a("#" + a.jgrid.jqID(b[1][c + 1])).hasClass("ui-state-disabled")
            ? a("#nData", l + "_2").addClass("ui-state-disabled")
            : a("#nData", l + "_2").removeClass("ui-state-disabled");
        }
        function v() {
        ...
        if (d.grid && s) {
          var p = d.p.id,
            ...
            g = a.jgrid.jqID(g);
          "new" === s
            ? ((s = "_empty"), (w = "add"), (c.caption = b[d.p.id].addCaption))
            : ((c.caption = b[d.p.id].editCaption), (w = "edit"));
          !0 === c.recreateForm &&
            void 0 !== a("#" + a.jgrid.jqID(n.themodal))[0] &&
            a("#" + a.jgrid.jqID(n.themodal)).remove();
          var G = !0;
          c.checkOnUpdate && c.jqModal && !c.modal && (G = !1);
          if (void 0 !== a("#" + a.jgrid.jqID(n.themodal))[0]) {
            k = a(d).triggerHandler("jqGridAddEditBeforeInitData", [
              a("#" + a.jgrid.jqID(g)),
              w
            ]);
            void 0 === k && (k = !0);
            ...
            if (!1 === k) return;
            i();
            a(".ui-jqdialog-title", "#" + a.jgrid.jqID(n.modalhead)).html(
              c.caption
            );
            a("#FormError", l).hide();
            b[d.p.id].topinfo
              ? (a(".topinfo", l).html(b[d.p.id].topinfo),
                a(".tinfo", l).show())
              : a(".tinfo", l).hide();
            b[d.p.id].bottominfo
              ? (a(".bottominfo", l + "_2").html(b[d.p.id].bottominfo),
                a(".binfo", l + "_2").show())
              : a(".binfo", l + "_2").hide();
            u(s, d, g);
            "_empty" === s || !b[d.p.id].viewPagerButtons
              ? a("#pData, #nData", l + "_2").hide()
              : a("#pData, #nData", l + "_2").show();
            ...
            x && x.call(d, a("#" + g), w);
            a("#" + a.jgrid.jqID(n.themodal)).data(
              "onClose",
              b[d.p.id].onClose
            );
            ...
            y &&
              (a("#pData, #nData", l + "_2").css("float", "right"),
              a(".EditButton", l + "_2").css("text-align", "left"));
            ...
            c.checkOnUpdate &&
              ...
              a("a.ui-jqdialog-titlebar-close", "#" + a.jgrid.jqID(n.themodal))
                .unbind("click")
                .click(function () {
                  if (!f()) return false;
                  a.jgrid.hideModal("#" + a.jgrid.jqID(n.themodal), {
            ...
            if (b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate)
              (H =
                ...
                a("#sNew", "#" + a.jgrid.jqID(n.themodal)).click(function () {
                  q();
                  a("#" + g).data("disabled", false);
                  a(".confirm", "#" + a.jgrid.jqID(n.themodal)).hide();
                  return false;
            ...
            a(d).triggerHandler("jqGridAddEditAfterShowForm", [a("#" + g), w]);
            A && A.call(d, a("#" + g), w);
            a(".fm-button", "#" + a.jgrid.jqID(n.themodal)).hover(
              function () {
                a(this).addClass("ui-state-hover");
              },
              function () {
    ...
    viewGridRow: function (s, c) {
      ...
      return this.each(function () {
        function e() {
          (!0 === b[o.p.id].closeOnEscape || !0 === b[o.p.id].navkeys[0]) &&
            setTimeout(function () {
              a(
        ...
        function h(b, d, e, f) {
          ...
          a(d.p.colModel).each(function () {
            ...
            !i &&
              "right" === this.align &&
              (this.formatter && -1 !== a.inArray(this.formatter, t)
          ...
          a(d.p.colModel).each(function (b) {
            ...
            if ("cb" !== g && "subgrid" !== g && "rn" !== g && A) {
              ...
              0 === h.length &&
                ((h = a("<tr " + l + " rowpos='" + k + "'></tr>")
                  .addClass("FormData")
                  .attr("id", "trv_" + g)),
                a(h).append(r),
                a(e).append(h),
                (h[0].rp = k));
              a("td:eq(" + (p - 2) + ")", h[0]).html(
                "<b>" +
        ...
        function r(b, c) {
          var d = c[1].length - 1;
          0 === b
            ? a("#pData", "#" + t + "_2").addClass("ui-state-disabled")
            : void 0 !== c[1][b - 1] &&
              a("#" + a.jgrid.jqID(c[1][b - 1])).hasClass("ui-state-disabled")
            ? a("#pData", t + "_2").addClass("ui-state-disabled")
            : a("#pData", "#" + t + "_2").removeClass("ui-state-disabled");
          b === d
            ? a("#nData", "#" + t + "_2").addClass("ui-state-disabled")
            : void 0 !== c[1][b + 1] &&
              a("#" + a.jgrid.jqID(c[1][b + 1])).hasClass("ui-state-disabled")
            ? a("#nData", t + "_2").addClass("ui-state-disabled")
            : a("#nData", "#" + t + "_2").removeClass("ui-state-disabled");
        }
        function q() {
        ...
        if (o.grid && s) {
          var f = o.p.id,
            ...
            g = a.isFunction(b[o.p.id].beforeInitData)
          ...
          if (void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0]) {
            ...
            a("#FormError", "#" + t).hide();
            u(s, o);
            a.isFunction(b[o.p.id].beforeShowForm) &&
              b[o.p.id].beforeShowForm.call(o, a("#" + i));
            ...
            a.jgrid.createModal(
              ...
              a("#gview_" + a.jgrid.jqID(o.p.id))[0]
            );
            d &&
            ...
            a(".fm-button:not(.ui-state-disabled)", "#" + t + "_2").hover(
              function () {
                a(this).addClass("ui-state-hover");
              },
              function () {
            ...
            a("#nData", "#" + t + "_2").click(function () {
              ...
              if (b[0] !== -1 && b[1][b[0] + 1]) {
                a.isFunction(c.onclickPgButtons) &&
                  c.onclickPgButtons.call(o, "next", a("#" + i), b[1][b[0]]);
                u(b[1][b[0] + 1], o);
            ...
            a("#pData", "#" + t + "_2").click(function () {
              ...
              if (b[0] !== -1 && b[1][b[0] - 1]) {
                a.isFunction(c.onclickPgButtons) &&
                  c.onclickPgButtons.call(o, "prev", a("#" + i), b[1][b[0]]);
                u(b[1][b[0] - 1], o);
                a(o).jqGrid("setSelection", b[1][b[0] - 1]);
                a.isFunction(c.afterclickPgButtons) &&
                  c.afterclickPgButtons.call(
      ...
      return this.each(function () {
        ...
        if (e.grid && s) {
          var h = a.isFunction(b[e.p.id].beforeShowForm),
            ...
            r = a.isFunction(b[e.p.id].beforeInitData)
          ...
          if (void 0 !== a("#" + a.jgrid.jqID(m.themodal))[0]) {
            ...
            var l = isNaN(b[e.p.id].dataheight)
                ? b[e.p.id].dataheight
            ...
            a("#dData", "#" + i + "_2").click(function () {
              ...
              a.isFunction(b[e.p.id].onclickSubmit) &&
                (o = b[e.p.id].onclickSubmit.call(e, b[e.p.id], h) || {});
                ...
                g = a.extend(
                  {
                    ...
                    data: a.isFunction(b[e.p.id].serializeDelData)
                      ? b[e.p.id].serializeDelData.call(e, t)
                      : t,
                    complete: function (d, g) {
                      ...
                      if (d.status >= 300 && d.status !== 304) {
                        ...
                        f[1] = a.isFunction(b[e.p.id].errorTextFormat)
                          ? b[e.p.id].errorTextFormat.call(e, d)
                          : g +
                            " Status: '" +
                            d.statusText +
                            "'. Error code: " +
                        ...
                        a.isFunction(b[e.p.id].afterSubmit) &&
                          (f = b[e.p.id].afterSubmit.call(e, d, t));
                      if (f[0] === false) {
          ...
          if (f.grid && "string" === typeof b) {
            ...
            for (v = 0; v < t; v++) {
              ...
              0 === v
                ? ((m = b),
                  (l = f.p.id),
                  m === f.p.toppager && ((l += "_top"), (t = 1)))
                : ((m = f.p.toppager), (l = f.p.id + "_top"));
              "rtl" === f.p.direction &&
              ...
              c.add &&
                ...
                a("tr", g).append(i),
                a(i, g)
                  .attr({ title: c.addtitle || "", id: h.id || "add_" + l })
                  .click(function () {
                    a(this).hasClass("ui-state-disabled") ||
              ...
              c.edit &&
                ...
                a("tr", g).append(i),
                a(i, g)
                  .attr({ title: c.edittitle || "", id: e.id || "edit_" + l })
                  .click(function () {
              ...
              c.view &&
                ...
                a("tr", g).append(i),
                a(i, g)
                  .attr({ title: c.viewtitle || "", id: q.id || "view_" + l })
                  .click(function () {
                    if (!a(this).hasClass("ui-state-disabled")) {
                      var b = f.p.selrow;
                      if (b)
              ...
              c.del &&
                ...
                a("tr", g).append(i),
                a(i, g)
                  .attr({ title: c.deltitle || "", id: u.id || "del_" + l })
                  .click(function () {
                    if (!a(this).hasClass("ui-state-disabled")) {
                      var b;
                      if (f.p.multiselect) {
                  ...
                  .click(function () {
                    a(this).hasClass("ui-state-disabled") ||
                      (a.isFunction(c.searchfunc)
                        ? c.searchfunc.call(f, r)
                        : a(f).jqGrid("searchGrid", r));
                    return false;
                  })
                  .hover(d, p),
                r.showOnLoad && !0 === r.showOnLoad && a(i, g).click(),
                (i = null));
              c.refresh &&
                ((i = a("<td class='ui-pg-button ui-corner-all'></td>")),
                a(i).append(
                ...
                a("tr", g).append(i),
                a(i, g)
                  .attr({ title: c.refreshtitle || "", id: "refresh_" + l })
                  .click(function () {
                    if (!a(this).hasClass("ui-state-disabled")) {
              ...
              f.p._nvtd &&
                (i > f.p._nvtd[0] &&
                  (a(m + "_" + c.position, m).width(i), (f.p._nvtd[0] = i)),
                (f.p._nvtd[1] = i));
              g = i = i = null;
              this.nav = !0;
            }
    ...
    FormToGrid: function (b, c, e, h) {
      return this.each(function () {
        if (this.grid) {
          ...
          "add" === e
            ? a(this).jqGrid("addRowData", b, r, h)
            : "set" === e && a(this).jqGrid("setRowData", b, r);
        }
      });
    }
  });
        ...
        if (l) {
            ...
            if (!0 === this.p.ruleButtons) {
              ...
              h.bind("click", function () {
                ...
                for (c = 0; c < b.p.columns.length; c++) {
                  var e =
                      b.p.columns[c].search === void 0
                        ? true
                        : b.p.columns[c].search,
                    j = b.p.columns[c].hidden === true;
                  if (
                    (b.p.columns[c].searchoptions.searchhidden === true && e) ||
                    (e && !j)
                  ) {
                    f = b.p.columns[c];
                    break;
          ...
          this.createTableRowForRule = function (g, j) {
              ...
              if (i) {
                ...
                a(".input-elm", f).bind("change", function (e) {
                  ...
                  setTimeout(function () {
                    var d = e.target;
                    g.data =
                      d.nodeName.toUpperCase() === "SPAN" &&
                      i.searchoptions &&
                      a.isFunction(i.searchoptions.custom_value)
                        ? i.searchoptions.custom_value.call(
                            c,
            ...
            for (e = m = 0; e < b.p.columns.length; e++) {
              ...
              if (
                (!0 === b.p.columns[e].searchoptions.searchhidden && p) ||
                (p && !r)
              )
                (p = ""),
                  g.field === b.p.columns[e].name &&
                    ((p = " selected='selected'"), (m = e)),
                  (d +=
                    "<option value='" +
                    b.p.columns[e].name +
                    "'" +
            ...
            s.bind("change", function () {
              ...
              if (g.op === "nu" || g.op === "nn") {
                ...
                if (c.tagName.toUpperCase() === "SELECT") g.data = c.value;
            ...
            for (e = 0; e < h.length; e++)
              (o = a.inArray(h[e], q)),
                -1 !== o &&
                  ((p = g.op === b.p.ops[o].oper ? " selected='selected'" : ""),
                  (d +=
                    "<option value='" +
                    b.p.ops[o].oper +
                    "'" +
  ...
  a.jgrid.extend({
    editRow: function (c, b, e, n, h, j, p, g, f) {
      ...
      if ("object" === a.type(d[0])) k = d[0];
        ...
        (void 0 !== b && (k.keys = b),
        a.isFunction(e) && (k.oneditfunc = e),
        a.isFunction(n) && (k.successfunc = n),
        void 0 !== h && (k.url = h),
        void 0 !== j && (k.extraparam = j),
        a.isFunction(p) && (k.aftersavefunc = p),
        a.isFunction(g) && (k.errorfunc = g),
        a.isFunction(f))
      )
      ...
      return this.each(function () {
        ...
        if (
          d.grid &&
          ((j = a(d).jqGrid("getInd", c, !0)),
          !1 !== j &&
            ((n = a.isFunction(k.beforeEditRow)
              ? k.beforeEditRow.call(d, k, c)
              : void 0),
            void 0 === n && (n = !0),
            n &&
              "0" === (a(j).attr("editable") || "0") &&
              !a(j).hasClass("not-editable-row")))
        )
          (m = d.p.colModel),
            a('td[role="gridcell"]', j).each(function (l) {
              f = m[l].name;
              var j = !0 === d.p.treeGrid && f === d.p.ExpandColumn;
              if (j) b = a("span:first", this).html();
                ...
                try {
                  ...
                  b =
                    m[l].edittype && "textarea" === m[l].edittype
                      ? a(this).text()
                      : a(this).html();
                }
              if (
                ...
                "subgrid" !== f &&
                "rn" !== f &&
                (d.p.autoencode && (b = a.jgrid.htmlDecode(b)),
                (h[f] = b),
                !0 === m[l].editable)
              ) {
                null === g && (g = l);
                ...
                "select" === m[l].edittype &&
                  void 0 !== m[l].editoptions &&
                  !0 === m[l].editoptions.multiple &&
                  void 0 === m[l].editoptions.dataUrl &&
                  a.jgrid.msie &&
                  a(u).width(a(u).width());
                e++;
              }
            ...
            0 < e &&
              ...
              d.p.savedRow.push(h),
              a(j).attr("editable", "1"),
              a("td:eq(" + g + ") input", j).focus(),
              !0 === k.keys &&
                a(j).bind("keydown", function (f) {
                  if (27 === f.keyCode) {
              ...
              a(d).triggerHandler("jqGridInlineEditRow", [c, k]),
              a.isFunction(k.oneditfunc) && k.oneditfunc.call(d, c));
      });
    },
    saveRow: function (c, b, e, n, h, j, p) {
      ...
      if ("object" === a.type(g[0])) f = g[0];
        ...
        (a.isFunction(b) && (f.successfunc = b),
        void 0 !== e && (f.url = e),
        void 0 !== n && (f.extraparam = n),
        a.isFunction(h) && (f.aftersavefunc = h),
        a.isFunction(j) && (f.errorfunc = j),
        a.isFunction(p))
      )
        ...
        if ("1" === g) {
          ...
          a('td[role="gridcell"]', q).each(function (c) {
            ...
            if (
              ...
              switch (m.edittype) {
                ...
                case "select":
                  if (m.editoptions.multiple) {
                    ...
                    (i[o] = a("select option:selected", this).val()),
                      (v[o] = a("select option:selected", this).text());
                ...
                case "custom":
                  try {
                    if (
                      m.editoptions &&
                      a.isFunction(m.editoptions.custom_value)
                    ) {
                      if (
                        ((i[o] = m.editoptions.custom_value.call(
                          d,
              ...
              if (!1 === w[0]) return !1;
              d.p.autoencode && (i[o] = a.jgrid.htmlEncode(i[o]));
              "clientArray" !== f.url &&
                m.editoptions &&
                !0 === m.editoptions.NullIfEmpty &&
                "" === i[o] &&
                (r[o] = "null");
            }
          });
          if (!1 === w[0]) {
            try {
              ...
              a.jgrid.info_dialog(
                ...
                w[1],
                a.jgrid.edit.bClose,
                { left: l[0], top: l[1] + a(t).outerHeight() }
              );
            } catch (x) {
              alert(w[1]);
            }
          ...
          if (i) {
            ...
            if (void 0 === i[l] || "" === i[l]) i[l] = c;
              ...
              q.id !== d.p.idPrefix + i[l] &&
              ((g = a.jgrid.stripPref(d.p.idPrefix, c)),
              void 0 !== d.p._index[g] &&
                ((d.p._index[i[l]] = d.p._index[g]), delete d.p._index[g]),
              (c = d.p.idPrefix + i[l]),
              a(q).attr("id", c),
              d.p.selrow === t && (d.p.selrow = c),
              a.isArray(d.p.selarrrow) &&
                ((g = a.inArray(t, d.p.selarrrow)),
                0 <= g && (d.p.selarrrow[g] = c)),
              d.p.multiselect)
            )
              (g = "jqg_" + d.p.id + "_" + c),
                a("input.cbox", q).attr("id", g).attr("name", g);
          ...
          if ("clientArray" === f.url) {
            ...
            a("#lui_" + a.jgrid.jqID(d.p.id)).show(),
              (r = a.extend({}, i, r)),
              (r[l] = a.jgrid.stripPref(d.p.idPrefix, r[l])),
              a.ajax(
                a.extend(
                  {
                    url: f.url,
    ...
    restoreRow: function (c, b) {
      ...
      "object" === a.type(e[0])
        ? (n = e[0])
        : a.isFunction(b) && (n.afterrestorefunc = b);
      ...
      return this.each(function () {
        ...
        if (b.grid) {
          ...
          if (p !== false) {
            f = a.isFunction(n.beforeCancelRow)
              ? n.beforeCancelRow.call(b, cancelPrm, sr)
              : void 0;
            f === void 0 && (f = true);
            if (f) {
    ...
    addRow: function (c) {
      ...
      return this.each(function () {
        if (this.grid) {
          var b = this,
            e = a.isFunction(c.beforeAddRow)
              ? c.beforeAddRow.call(b, c.addRowParams)
              : void 0;
          void 0 === e && (e = !0);
          e &&
            ...
            a("#" + a.jgrid.jqID(c.rowID), "#" + a.jgrid.jqID(b.p.id)).addClass(
              "jqgrid-new-row"
            ),
            c.useFormatter
              ? a(
      ...
      return this.each(function () {
        if (this.grid) {
          ...
          b.edit &&
            a(e).jqGrid("navButtonAdd", c, {
              ...
              onClickButton: function () {
                ...
                c
                  ? (a(e).jqGrid("editRow", c, b.editParams),
                    a("#" + h + "_ilsave").removeClass("ui-state-disabled"),
                    a("#" + h + "_ilcancel").removeClass("ui-state-disabled"),
                    a("#" + h + "_iladd").addClass("ui-state-disabled"),
                    a("#" + h + "_iledit").addClass("ui-state-disabled"))
              ...
              onClickButton: function () {
                ...
                if (c) {
                  ...
                  a("#" + a.jgrid.jqID(c), "#" + h).hasClass("jqgrid-new-row")
                    ? ((b.addParams.addRowParams.extraparam[k] = f.addoper),
                      (d = b.addParams.addRowParams))
                    : (b.editParams.extraparam ||
                        (b.editParams.extraparam = {}),
                      (b.editParams.extraparam[k] = f.editoper),
                      (d = b.editParams));
          ...
          !0 === b.restoreAfterSelect &&
            ((n = a.isFunction(e.p.beforeSelectRow) ? e.p.beforeSelectRow : !1),
            ...
            if (
              ...
              try {
                e = b.unformat.call(
                  c,
                  h,
                  { rowId: c.rows[d].id, colModel: i },
                  f
                );
              } catch (k) {
                e =
                  i.edittype && "textarea" === i.edittype
                    ? b(h).text()
                    : b(h).html();
              }
          ...
          if (null !== c) {
            ...
            switch (i.edittype) {
              ...
              case "custom":
                try {
                  if (
                    i.editoptions &&
                    b.isFunction(i.editoptions.custom_value)
                  ) {
                    e = i.editoptions.custom_value.call(
                      a,
                      b(".customelement", g),
                      "get"
                    );
            ...
            if (h !== a.p.savedRow[c].v) {
              ...
              if (
                ...
                (c = a.p.beforeSaveCell.call(a, a.rows[d].id, k, e, d, f))
              )
                h = e = c;
                      ...
                      b.extend(
                        {
                          ...
                          data: b.isFunction(a.p.serializeCellData)
                            ? a.p.serializeCellData.call(a, m)
                            : m,
                          type: "POST",
    ...
    addSubGrid: function (d, c) {
      return this.each(function () {
        ...
        if (a.grid) {
                      ...
                      b.extend(
                        {
                          ...
                          complete: function (c) {
                            a.p.subgridtype === "xml"
                              ? l(c.responseXML, e)
                              : o(b.jgrid.parse(c.responseText), e);
                          }
                        },
                        b.jgrid.ajaxOptions,
          ...
          for (; n < r; )
            b(a.rows[n]).hasClass("jqgrow") &&
              b(a.rows[n].cells[d]).bind("click", function () {
                ...
                if (b(this).hasClass("sgcollapsed")) {
                  ...
                  if (
                    ...
                    (g = g === false || g === "stop" ? false : true) &&
                      ...
                      (g = a.p.subGridBeforeExpand.call(a, k + "_" + e, e));
                    ...
                    b(c).after(
                      "<tr role='row' class='ui-subgrid'>" +
                        ...
                        "'></span></td><td colspan='" +
                        parseInt(a.p.colNames.length - 1 - q, 10) +
                    ...
                    b.isFunction(a.p.subGridRowExpanded)
                      ? a.p.subGridRowExpanded.call(a, k + "_" + e, e)
                      : s(c);
                  } else b(j).show();
                  b(this)
                    .html(
          ...
          if (a.groupField.length) {
            ...
            for (b = 0; b < a.groupField.length; b++)
              a.groupOrder[b] || (a.groupOrder[b] = "asc"),
                ...
                "boolean" !== typeof a.groupColumnShow[b] &&
                  (a.groupColumnShow[b] = !0),
                "boolean" !== typeof a.groupSummary[b] &&
                  (a.groupSummary[b] = !1),
                !0 === a.groupColumnShow[b]
                  ? ((a.visibiltyOnNextGrouping[b] = !0),
                    e(this).jqGrid("showCol", a.groupField[b]))
                  : ((a.visibiltyOnNextGrouping[b] = e(
                      "#" + e.jgrid.jqID(this.p.id + "_" + a.groupField[b])
                    ).is(":visible")),
            ...
            void 0 !== i &&
              (0 === a
                ...
                : "object" !== typeof i &&
                  ...
                  e.isFunction(d.isInTheSameGroup[c])
                    ? !d.isInTheSameGroup[c].call(h, d.lastvalues[c], i, c, d)
                    : d.lastvalues[c] !== i)
                ? (d.groups.push({
                    idx: c,
                    dataIndex: m,
                ...
                : ((d.counters[c].cnt += 1),
                  (d.groups[d.counters[c].pos].cnt = d.counters[c].cnt)),
              e.each(d.counters[c].summary, function () {
    ...
    groupingToggle: function (b) {
      this.each(function () {
          ...
          if (g.showSummaryOnHide) {
            if (c)
              for (
                ...
                !(
                  e(c).hasClass("jqfoot") &&
                  parseInt(e(c).attr("jqfootlevel"), 10) <= a
                );

              )
                e(c).hide(), (c = c.nextSibling);
          } else if (c)
            for (; c; ) {
              g = m(c.className);
        ...
        e.isFunction(this.p.onClickGroup) &&
          this.p.onClickGroup.call(this, b, k);
      });
      return !1;
    },
    groupingRender: function (b, g) {
      return this.each(function () {
        ...
        var a = this,
          ...
          l,
          m,
          i = d.groupCollapse ? d.plusicon : d.minusicon,
          k,
          q = [],
        ...
        e.each(d.groups, function (s, j) {
          ...
          c =
            ...
            "');return false;\"></span>";
          try {
            e.isArray(d.formatDisplayField) &&
            e.isFunction(d.formatDisplayField[j.idx])
              ? ((j.displayValue = d.formatDisplayField[j.idx].call(
                  a,
                  j.displayValue,
                  j.value,
                  a.p.colModel[q[j.idx]],
                  j.idx,
                  d
                )),
                (k = j.displayValue))
              : (k = a.formatter(l, j.displayValue, q[j.idx], j.value));
          } catch (C) {
            k = j.displayValue;
          }
          h +=
            ...
            l +
            '"' +
            (d.groupCollapse && 0 < j.idx ? ' style="display:none;" ' : " ") +
            ...
            '">' +
            c +
            e.jgrid.template(d.groupText[j.idx], k, j.cnt, j.summary) +
            "</td></tr>";
          if (w - 1 === j.idx) {
            var o = d.groups[s + 1],
              p,
              n,
              B = void 0 !== o ? d.groups[s + 1].startRow : b.length;
            for (n = j.startRow; n < B; n++) h += b[n].join("");
            var r;
            if (void 0 !== o) {
              for (
                r = 0;
                r < d.groupField.length && o.dataIndex !== d.groupField[r];
                r++
              );
      ...
      return this.each(function () {
        ...
        for (a = 0; a < f.groupField.length; a++)
          !f.groupColumnShow[a] &&
            ...
            e(this).jqGrid("showCol", f.groupField[a]);
        for (a = 0; a < b.length; a++)
          f.visibiltyOnNextGrouping[a] = e(
            "#" + e.jgrid.jqID(this.p.id) + "_" + e.jgrid.jqID(b[a])
          ).is(":visible");
      ...
      return this.each(function () {
        ...
        if (!0 === b) {
          ...
          e(
            ...
            "#" + e.jgrid.jqID(this.p.id) + " tbody:first"
          ).remove();
          e(
            "tr.jqgrow:hidden",
            "#" + e.jgrid.jqID(this.p.id) + " tbody:first"
      ...
      handler: function (b, e, f, a, d, h) {
        var c = {
          ...
          min: function () {
            return "" === e
              ? parseFloat(h[f] || 0)
              : Math.min(parseFloat(e), parseFloat(h[f] || 0));
          },
          max: function () {
            return "" === e
              ? parseFloat(h[f] || 0)
              : Math.max(parseFloat(e), parseFloat(h[f] || 0));
          },
          count: function () {
            "" === e && (e = 0);
          ...
          for (
            ...
            (j = d.jgrid.stripPref(a.p.idPrefix, a.rows[b].id)),
              ...
              "nested" === a.p.treeGridModel &&
                !j[i] &&
                ((k = parseInt(j[a.p.treeReader.left_field], 10)),
              ...
              (n += "></div></div>"),
              d(a.rows[b].cells[h])
                .wrapInner("<span class='cell-wrapper" + m + "'></span>")
                .prepend(n),
              k !== parseInt(a.p.tree_root_level, 10) &&
                ((j =
                  (j = d(a).jqGrid("getNodeParent", j)) && j.hasOwnProperty(e)
                    ? j[e]
                    : !0) ||
      ...
      return this.each(function () {
        ...
        if (b.p.treeGrid) {
          ...
          b.p.treeIcons = d.extend(
            {
              plus:
                "ui-icon-triangle-1-" + ("rtl" === b.p.direction ? "w" : "e"),
          ...
          for (e in b.p.colModel)
            if (b.p.colModel.hasOwnProperty(e))
              ...
              h === b.p.ExpandColumn && !a && ((a = !0), (b.p.expColInd = c)),
              c++,
              b.p.treeReader))
          ...
          switch (a.p.treeGridModel) {
            ...
            case "adjacency":
              var k = a.p.treeReader.parent_id_field,
                m = a.p.localReader.id;
              d(this.p.data).each(function () {
                this[k] == d.jgrid.stripPref(a.p.idPrefix, b[m]) &&
                  c.push(this);
              });
          }
      });
      ...
      return this.each(function () {
        if (this.grid && this.p.treeGrid) {
          ...
          d.each(f, function (a) {
            ...
            d("#" + d.jgrid.jqID(l.p.id) + " tbody tr:eq(" + a + ")").after(
              d("tr#" + d.jgrid.jqID(b), l.grid.bDiv)
            );
          });
          f = k = e = null;
        }
          ...
          if (null !== c) {
            ...
            if (f.length)
              for (o in f)
                f.hasOwnProperty(o) &&
                  ((f[o][k] =
                    f[o][k] > g ? parseInt(f[o][k], 10) + 2 : f[o][k]),
                  (f[o][m] =
                    f[o][m] >= g ? parseInt(f[o][m], 10) + 2 : f[o][m]));
            a[k] = g;
            a[m] = g + 1;
          } else {
                  ...
                  return b.extend(
                    {
                      accept: function (a) {
                        ...
                        if (a.length > 0 && b.data(a[0], "dnd") !== void 0) {
                          ...
                          return b.inArray("#" + b.jgrid.jqID(this.id), a) !==
                            -1
                            ? true
                            : false;
                        }
                        ...
                        if (b(d.draggable).hasClass("jqgrow")) {
                          ...
                          if (!a.dropbyname) {
                            var g = 0,
                              ...
                              h,
                              l,
                              p = b("#" + b.jgrid.jqID(this.id)).jqGrid(
                                "getGridParam",
                                "colModel"
                              );
                            try {
