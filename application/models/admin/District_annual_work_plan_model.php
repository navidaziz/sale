...
class District_annual_work_plan_model extends MY_Model
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->table = "district_annual_work_plans";
        $this->pk = "district_annual_work_plan_id";
        $this->status = "status";
        $this->order = "order";
    }
    ...
    public function save_data($image_field = NULL)
    {
        ...
        return $this->district_annual_work_plan_model->save($inputs);
    }
    ...
    public function update_data($annual_work_plan_id, $image_field = NULL)
    {
        ...
        return $this->district_annual_work_plan_model->save($inputs, $annual_work_plan_id);
    }

    //----------------------------------------------------------------
    public function get_district_annual_work_plan_list($where_condition = NULL, $pagination = TRUE, $public = FALSE)
    {
        $data = (object) array();
        $fields = array(
        ...
        if ($pagination) {
            ...
            if ($public) {
                ...
                $this->district_annual_work_plan_model->uri_segment = $this->uri->segment(3);
            ...
            $data->annual_work_plans = $this->district_annual_work_plan_model->joinGet($fields, "annual_work_plans", $join_table, $where);
            return $data;
        } else {
            return $this->district_annual_work_plan_model->joinGet($fields, "annual_work_plans", $join_table, $where, FALSE, TRUE);
        }
    }

    public function get_district_annual_work_plan($annual_work_plan_id)
    {
