    ...
    <div class="col-md-12">
        <div class="box border blue" id="messenger">
            ...
            <div class="box-body">
                ...
                echo form_open_multipart("suppliers/update_data/$supplier->supplier_id", $edit_form_attr);
                ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        $text = array(
                            ...
                            "style"         =>  "",
                            "required"      => "required",
                            "title"         =>  $this->lang->line('supplier_name'),
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        $text = array(
                            ...
                            "style"         =>  "",
                            "required"      => "required",
                            "title"         =>  $this->lang->line('supplier_contact_no'),
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        $text = array(
                            ...
                            "style"         =>  "",
                            "required"      => "required",
                            "title"         =>  $this->lang->line('company_name'),
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        $text = array(
                            ...
                            "style"         =>  "",
                            "required"      => "required",
                            "title"         =>  $this->lang->line('account_number'),
