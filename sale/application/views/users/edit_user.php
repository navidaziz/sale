	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(."users/update_data/$user->user_id", $edit_form_attr);
            ?>
            ...
            <div class="form-group">
                ...
                <?php
                    $label = array(
                        "class" => "col-md-2 control-label",
                        "style" => "",
                    ); echo form_label($this->lang->line('userName'), "userName", $label);      ?>
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "id"            =>  "userName",
                        "class"         =>  "form-control",
                        "style"         =>  "","required"	  => "required","title"         =>  $this->lang->line('userName'),
