                ...
                foreach ($impact_quarters as $impact_quarter) { ?>
                    ...
                    <?php foreach ($impact_quarters as $impact_quarter) { ?>
                        <?php foreach ($sub_components as $sub_component) { ?>
                            ...
                            $survey_count = $this->db->query($query, [$district->district, $impact_quarter->impact_quarter_id, $sub_component->sub_component])->row();
                            ?>
                            <td><?php
            ...
            foreach ($impact_quarters as $impact_quarter) { ?>
                ...
                <?php foreach ($impact_quarters as $impact_quarter) { ?>
                    <?php foreach ($sub_components as $sub_component) { ?>
                        ...
                        $survey_count = $this->db->query($query, [$impact_quarter->impact_quarter_id, $sub_component->sub_component])->row();
                        ?>
                        <td><?php
                            $cumulative += $survey_count->total;
                            echo $survey_count->total;  ?></td>
