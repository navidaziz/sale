        ...
        <div class="page-header">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    ...
                    <a href="<?php echo site_url(ADMIN_DIR . "projects/view/"); ?>"><?php echo $this->lang->line('Projects'); ?></a>
                </li>
    ...
    <div class="col-md-12">
        <div class="box border blue" id="messenger">
            ...
            <div class="box-body">
                ...
                echo form_open_multipart(ADMIN_DIR . "projects/update_data/$project->project_id", $edit_form_attr);
                ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        $text = array(
                            ...
                            "value"         =>  set_value("project_name", $project->project_name),
                ...
                <div class="form-group">
                    ...
                    echo form_label($this->lang->line('cost'), "cost", $label);      ?>
                    ...
                    <div class="col-md-8">
                        ...
                        $number = array(
                            ...
                            "id"            =>  "cost",
                            "class"         =>  "form-control",
                            "style"         =>  "", "required"      => "required", "title"         =>  $this->lang->line('cost'),
                            "value"         =>  set_value("cost", $project->cost),
                ...
                <div class="form-group">
                    ...
                    echo form_label($this->lang->line('project_detail'), "project_detail", $label);
                    ?>
                    ...
                    <div class="col-md-8">
                        ...
                        $textarea = array(
                            ...
                            "class"         =>  "form-control",
                            "style"         =>  "",
                            "title"         =>  $this->lang->line('project_detail'), "required"      => "required",
                            "rows"          =>  "",
                            "cols"          =>  "",
                            "value"         => set_value("project_detail", $project->project_detail),
                            "placeholder"   =>  $this->lang->line('project_detail')
                        );
                        echo form_textarea($textarea);
                        ?>
                        <?php echo form_error("project_detail", "<p class=\"text-danger\">", "</p>"); ?>
                    </div>
