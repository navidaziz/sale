...
class Expense_types extends Admin_Controller{
    ...
    /**
     ...
     public function add(){
        ...
        $this->data["title"] = $this->lang->line('Add New Expense Type');$this->data["view"] = ADMIN_DIR."expense_types/add_expense_type";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
     ...
     public function edit($expense_type_id){
        ...
        $this->data["title"] = $this->lang->line('Edit Expense Type');$this->data["view"] = ADMIN_DIR."expense_types/edit_expense_type";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
