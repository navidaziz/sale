    ...
    <div class="col-md-9">
        <div class="box border blue" id="messenger">
            ...
            <div class="box-body">
                ...
                <div class="table-responsive">
                    <!-- <form method="post" action="<?php echo  site_url("items/add_item_stocks") ?>">
                    ...
                    <form method="post" action="<?php echo  site_url("items/return_item_stocks") ?>">
                        <input type="hidden" name="item_id" id="item_id" value="<?php echo $items[0]->item_id; ?>" />
                        ...
                        <tbody>
                            ...
                            foreach ($inventories as $inventory) : ?>
                                <tr>
                                    ...
                                    <!-- <td><a href="<?php echo site_url("suppliers/remove_supplier_item/" . $inventory->supplier_id . "/" . $inventory->supplier_invoice_id . "/" . $inventory->inventory_id) ?>">Remove</a></td>
                                </tr> -->
                    ...
                    <div>
                        ...
                        foreach ($item_sales as $sale) {
                            echo "Item Sold on " . date('d M, Y', strtotime($sale->created_date)) . " - Qty: " . $sale->sale_items . " - Total Price: " . $sale->total_price . "<br />";
                        }
                        ?>
